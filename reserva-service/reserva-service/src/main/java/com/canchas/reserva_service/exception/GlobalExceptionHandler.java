...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarErrorFeign(FeignException ex) {
        Map<String, Object> error = new HashMap<>();
        error.put("timestamp", LocalDateTime.now());
        error.put("estado", HttpStatus.SERVICE_UNAVAILABLE.value());
        error.put("error", "Servicio no disponible");
        error.put("mensaje", "No se pudo comunicar con un servicio necesario. " +
    ...
    public ResponseEntity<Map<String, Object>> manejarJsonInvalido(
        ...
        error.put("mensaje", "El cuerpo de la solicitud es inválido. " +
                "Revisa que el método de pago sea EFECTIVO, TARJETA o TRANSFERENCIA.");
